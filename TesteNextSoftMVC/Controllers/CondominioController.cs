...
namespace TesteNextSoftMVC.Controllers
{
    public class CondominioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Bairro,AreaTotalCondominio,ValorIPTU")] Condominio condominio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Bairro,AreaTotalCondominio,ValorIPTU")] Condominio condominio)
        {
            if (id != condominio.Id)
            {
                return NotFound();
